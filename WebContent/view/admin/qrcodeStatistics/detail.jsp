...
<script src="${basePath}assets/scripts/admin.qrcode.statistics.detail.js"></script>
</head>
<body>
		...
		<div class="panel panel-default" id="test-panel">
			<div class='panel-heading'>
				<h4 class='panel-title'>
					详细数据 <a data-toggle='collapse' href='#collapse-test-panel'
			...
			<div id="collapse-test-panel" class="panel-collapse collapse in">
				...
				<div class="form-group">
					<label class="col-sm-1 control-label">省:</label> <input type="text"
						class="form-control" name="Province" placeholder="请选择省"
						maxlength="20" id="txt-province">
				</div>
				<div class="form-group">
