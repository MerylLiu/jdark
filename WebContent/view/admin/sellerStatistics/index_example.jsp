	...
	<div class="container-fluid page-container">
		...
		<div class="panel-body no-padding">
			<ul class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active"><a href="#total" aria-controls="total" id="tab-total" role="tab" data-toggle="tab">视频点击量</a></li>
				<li role="presentation"><a href="#timeInterval" aria-controls="timeInterval" id="tab-interval" role="tab" data-toggle="tab">分时段点击量</a></li>
			</ul>
			<form class="form-horizontal tab-filter border-bottom" id="form-data">
				<br />
