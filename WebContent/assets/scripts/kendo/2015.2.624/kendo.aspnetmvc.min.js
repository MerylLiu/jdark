 ...
 */
! function(e, define) {
    define(["./kendo.data.min", "./kendo.combobox.min", "./kendo.dropdownlist.min", "./kendo.multiselect.min", "./kendo.validator.min"], e)
}(function() {
    return function(e, t) {
            function n(t, n, i, r) {
                var o = {};
                ...
                }).join("~"), delete t.aggregate), t.filter ? (o[this.options.prefix + "filter"] = l(t.filter, i), delete t.filter) : (o[this.options.prefix + "filter"] = "", delete t.filter), delete t.take, delete t.skip, a(o, t, "", r), o
            }
            ...
            function o(e, n, i, o, l, d) {
                m(n) ? s(e, n, l, d) : v(n) ? a(e, n, l, d) : e[l] === t && (e[l] = i[o] = r(n, d))
            }

            function a(e, t, n, i) {
                var r, a, s;
                for (r in t) a = n ? n + "." + r : r, s = t[r], o(e, s, t, r, a, i)
            }

            function s(e, t, n, i) {
                var r, a, s, l, d;
                for (r = 0, a = 0; t.length > r; r++) s = t[r], l = "[" + a + "]", d = n + l, o(e, s, t, l, d, i), a++
            }
            ...
            function h(e) {
                ...
                for (t in e) {
                    r = {}, i = e[t];
                    for (n in i) r[n.toLowerCase()] = i[n];
                    e[t] = r
                }
                return e
            }
                ...
                schemas: {
                    "aspnetmvc-ajax": {
                        ...
                        aggregates: function(e) {
                            e = e.d || e;
                            var t, n, i, r = {},
                                o = e.AggregateResults || [];
                            for (n = 0, i = o.length; i > n; n++) t = o[n], r[t.Member] = g(!0, r[t.Member], u(t));
                            return r
                        }
                    }
                }
        ...
        function(e) {
            var t = window.kendo,
                n = t.ui;
            n && n.DropDownList && (n.DropDownList.requestData = function(t) {
                var n = e(t).data("kendoDropDownList"),
                    i = n.dataSource.filter(),
                    r = n.filterInput,
                    o = r ? r.val() : "";
                return i || (o = ""), {
        ...
        function(e) {
            ...
            n(!0, t.data, {
                ...
                schemas: {
                    "filebrowser-aspnetmvc": t.data.schemas["imagebrowser-aspnetmvc"]
                }
            }), n(!0, t.data, {
                transports: {
                    "imagebrowser-aspnetmvc": t.data.RemoteTransport.extend({
                        ...
                        _call: function(n, r) {
                            ...
                            }), i(this.options[n]) ? this.options[n].call(this, r) : t.data.RemoteTransport.fn[n].call(this, r)
                        },
                        read: function(e) {
                            this._call("read", e)
                        },
                ...
                transports: {
                    "filebrowser-aspnetmvc": t.data.transports["imagebrowser-aspnetmvc"]
                }
            })
        }(window.kendo.jQuery),
        function(e) {
            ...
            function i(e, t) {
                var n, i, r, o = {},
                    a = e.data(),
                    s = t.length;
                for (r in a) i = r.toLowerCase(), n = i.indexOf(t), n > -1 && (i = i.substring(n + s, r.length), i && (o[i] = a[r]));
                return o
            }
            ...
            function r(t) {
                var n, i, r = t.Fields || [],
                    a = {};
                for (n = 0, i = r.length; i > n; n++) e.extend(!0, a, o(r[n]));
                return a
            }
            ...
            function o(e) {
                var t, n, i, r, o = {},
                    ...
                    s = e.FieldName,
                    c = e.ValidationRules;
                for (i = 0, r = c.length; r > i; i++) t = c[i].ValidationType, n = c[i].ValidationParameters, o[s + t] = d(s, t, n), a[s + t] = l(c[i].ErrorMessage);
                return {
                    rules: o,
                    messages: a
                }
            ...
            var u = /("|\%|'|\[|\]|\$|\.|\,|\:|\;|\+|\*|\&|\!|\#|\(|\)|<|>|\=|\?|\@|\^|\{|\}|\~|\/|\||`)/g,
                h = {
                    required: function(e) {
                        ...
                        return r.length && (t = r[0].name.replace(u, "\\$1"), n = r.next("input:hidden[name='" + t + "']"), i = n.length ? n.val() : "checked" === e.attr("checked")), !("" === i || !i)
                    },
                    number: function(e) {
                ...
                ruleResolvers: {
                    mvcMetaDataResolver: {
                        resolve: function(t) {
                            ...
                            if (i.length)
                                for (t = e(t), n = 0; i.length > n; n++)
                                    if (i[n].FormId == t.attr("id")) return r(i[n]);
                            return {}
                        }
                    }
                }
